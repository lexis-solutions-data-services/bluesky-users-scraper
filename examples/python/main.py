"""
Example: How to call the bluesky-users-scraper actor using Apify API Client

For full documentation of the Apify Client for Python, see: https://docs.apify.com/api/client/python
For full documentation of the actor, see: https://apify.com/lexis-solutions/bluesky-users-scraper
...
def run_actor():
    """Run the bluesky-users-scraper actor and retrieve results."""
    ...
    actor_id = "lexis-solutions/bluesky-users-scraper"
